...
static ini1_header_t *package2_rebuild_ini1(ini1_header_t *ini1, uint32_t target_firmware, void *emummc, size_t emummc_size, void* ncm_inject, size_t ncm_inject_size);
...
void package2_rebuild_and_copy(package2_header_t *package2, uint32_t target_firmware, void *emummc, size_t emummc_size, void* ncm_inject, size_t ncm_inject_size) {
    ...
    rebuilt_ini1 = package2_rebuild_ini1(orig_ini1, target_firmware, emummc, emummc_size, ncm_inject, ncm_inject_size);
...
static ini1_header_t *package2_rebuild_ini1(ini1_header_t *ini1, uint32_t target_firmware, void *emummc, size_t emummc_size, void* ncm_inject, size_t ncm_inject_size) {
    ...
    merged = stratosphere_merge_inis(inis_to_merge, STRATOSPHERE_INI1_MAX, emummc, emummc_size, ncm_inject, ncm_inject_size);
