...
#include <stratosphere/settings/settings_i_factory_settings_server.hpp>
...
#include <stratosphere/settings/factory/settings_battery_lot.hpp>
...
#include <stratosphere/settings/factory/settings_region.hpp>
